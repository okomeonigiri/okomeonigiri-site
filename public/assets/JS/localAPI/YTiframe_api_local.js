var scriptUrl = '/assets/JS/localAPI/www-widgetapi.js'; // 保存した場所に合わせてパスを調整
try {
  var ttPolicy = window.trustedTypes && window.trustedTypes.createPolicy
    ? window.trustedTypes.createPolicy("youtube-widget-api", { createScriptURL: function(x){ return x; } })
    : null;
  if (ttPolicy) scriptUrl = ttPolicy.createScriptURL(scriptUrl);
} catch(e) {}
var YT;
